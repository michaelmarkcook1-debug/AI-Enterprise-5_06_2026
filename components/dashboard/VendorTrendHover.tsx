    ...
    <div className="group/trend relative">
      ...
      >
        ...
        >
          ...
          {/* baseline grid */}
          <line x1={PAD_X} y1={CHART_H - PAD_Y} x2={CHART_W - PAD_X} y2={CHART_H - PAD_Y} stroke="currentColor" strokeWidth="1" className="text-[#efe9d9] dark:text-[#20314a]" />
          <line x1={PAD_X} y1={PAD_Y} x2={CHART_W - PAD_X} y2={PAD_Y} stroke="currentColor" strokeWidth="1" className="text-[#efe9d9] dark:text-[#20314a]" />
          {/* momentum line (faint, secondary metric) */}
          <path d={momentumPath} fill="none" stroke="currentColor" strokeWidth="1.25" strokeDasharray="3 2.5" className="text-[#9aa691] dark:text-[#8fa5bb]" />
          {/* score area + line */}
        ...
        <div className="mt-1 flex items-center justify-between text-[10px] text-[#5e6b7e] dark:text-[#8fa5bb]">
        ...
        <div className="mt-1.5 text-[9px] leading-3 text-[#9aa691] dark:text-[#7d93aa]">
