    ...
    >
      ...
      {open && (
        ...
        >
          ...
          <span className="mt-0.5 block text-[10px] text-[#5b6b7f] dark:text-[#8fa5bb]">
            {first.date} → {last.date} · {points.length} points
          </span>
          <span className="mt-1 block text-[9px] uppercase tracking-wide text-[#7e8a99] dark:text-[#8fa5bb]">
