...
const TIER_STYLE: Record<AssessmentTier, {
  ...
  quick: {
    ...
    inactiveClass:
      "border-emerald-200 bg-emerald-50/60 text-[#15263c] hover:bg-emerald-100/70 dark:border-emerald-900/70 dark:bg-emerald-950/40 dark:text-[#eef3f8] dark:hover:bg-emerald-950/60",
    metaActive: "text-white/85",
    metaInactive: "text-emerald-800/80 dark:text-emerald-300",
    descActive: "text-white/90",
    descInactive: "text-[#2e3f57] dark:text-[#c2d1e0]",
  ...
  guided: {
    ...
    inactiveClass:
      "border-sky-200 bg-sky-50/60 text-[#15263c] hover:bg-sky-100/70 dark:border-sky-900/70 dark:bg-sky-950/40 dark:text-[#eef3f8] dark:hover:bg-sky-950/60",
    metaActive: "text-white/85",
  ...
  advanced: {
    ...
    inactiveClass:
      "border-amber-200 bg-amber-50/60 text-[#15263c] hover:bg-amber-100/70 dark:border-amber-900/70 dark:bg-amber-950/40 dark:text-[#eef3f8] dark:hover:bg-amber-950/60",
    metaActive: "text-white/85",
...
export default function TierBar({ current }: Props) {
  ...
  return (
    <div className="mb-6 rounded-xl border border-[#e6dcc3] bg-white p-4 dark:border-[#1d3a57] dark:bg-[#0c2238]">
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="text-xs font-medium uppercase tracking-wider text-[#4c5d75]">
          Assessment depth
        </div>
                ...
                <div
                  className={`whitespace-nowrap rounded-full border px-1.5 py-0.5 text-[9px] font-semibold ${
                    active
                      ...
                      : "border-current/30 text-[#4c5d75] dark:text-[#a7bacd]"
                  }`}
      ...
      <p className="mt-3 text-[11px] text-[#4c5d75]">
