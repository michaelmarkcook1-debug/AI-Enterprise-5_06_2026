...
// Market-share is now an evidence-derived presence share (lib/system/market-presence.ts,
// tested in market-presence.test.ts) — the old seed-baseline momentum tilt was removed.
