...
const vA: Vendor = (() => {
  ...
  return {
    ...
    certifications: ["soc2_type2", "iso_27001", "iso_42001", "hipaa", "fedramp_moderate", "gdpr_eu_dpa"],
    deploymentModels: ["saas", "vpc", "byoc"],
    regions: ["us", "eu", "uk", "apac"],
    ecosystemNative: ["azure", "microsoft_365_copilot", "microsoft_fabric", "azure_openai", "aws", "aws_bedrock", "salesforce", "servicenow"],
    supportedSystemsOfRecord: ["epic", "oracle_health_cerner", "salesforce_gov_cloud", "sap_public", "servicenow_itsm", "github"],
    pricingModels: ["per_seat", "per_token", "committed_use", "flat_platform"],
    evalEvidence: ["independent_eval", "model_card", "safety_eval"],
...
const vB: Vendor = (() => {
  ...
  return {
    ...
    certifications: ["soc2_type2", "gdpr_eu_dpa"],
    deploymentModels: ["saas", "vpc"],
    regions: ["us", "eu"],
    ecosystemNative: ["aws_bedrock", "azure_openai", "snowflake", "databricks", "langsmith", "pinecone"],
    supportedSystemsOfRecord: ["github", "snowflake_data", "databricks_data"],
    pricingModels: ["per_token", "committed_use"],
    evalEvidence: ["independent_eval", "model_card"],
...
const vC: Vendor = (() => {
  ...
  return {
    ...
    certifications: ["soc2_type2", "gdpr_eu_dpa", "iso_27001"],
    deploymentModels: ["saas", "vpc"],
    regions: ["us", "uk", "eu"],
    ecosystemNative: ["azure", "microsoft_365_copilot", "sharepoint_legal"],
    supportedSystemsOfRecord: ["imanage", "netdocuments", "relativity", "sharepoint_legal"],
    pricingModels: ["per_seat"],
    evalEvidence: ["independent_eval", "model_card"],
...
const vD: Vendor = (() => {
  ...
  return {
    ...
    certifications: ["iso_27001", "fedramp_high", "nist_800_171", "iec_62443"],
    deploymentModels: ["self_host", "on_prem", "vpc", "byoc"],
    regions: ["us", "eu", "uk", "apac"],
    ecosystemNative: ["aws", "azure", "gcp", "databricks", "vllm_self_host", "meta_llama", "mistral", "postgres", "langfuse", "mcp", "opa"],
    supportedSystemsOfRecord: ["palantir_foundry", "aveva_pi", "esri_arcgis"],
    pricingModels: ["flat_platform", "committed_use"],
    evalEvidence: ["independent_eval", "model_card"],
...
const vE: Vendor = (() => {
  ...
  return {
    ...
    certifications: ["soc2_type2", "hipaa", "iso_27001"],
    deploymentModels: ["saas", "vpc"],
    regions: ["us"],
    ecosystemNative: ["azure", "azure_openai", "aws", "epic"],
    supportedSystemsOfRecord: ["epic", "oracle_health_cerner", "veeva_vault", "salesforce_health_cloud"],
    pricingModels: ["per_seat", "committed_use"],
    evalEvidence: ["independent_eval", "safety_eval"],
...
const vF: Vendor = (() => {
  ...
  return {
    ...
    regions: ["us"],
    ecosystemNative: ["salesforce", "google_workspace", "atlassian", "openai", "langsmith"],
    supportedSystemsOfRecord: ["salesforce", "atlassian_jira"],
    pricingModels: ["per_token", "per_seat"],
    evalEvidence: [],
