...
export const INTELLIGENCE_VENDORS: Vendor[] = [
  ...
  vendor("cohere", "Cohere", "Frontier model/API", 70, 68, "Toronto, Canada", "private", ["RAG/enterprise search", "Regulated-industry AI", "Frontier model/API"], "Enterprise-oriented model provider focused on secure, private/sovereign deployment and retrieval (Command / Embed / Rerank). A tier-2 specialist — ~$7B valuation and ~$240M ARR (analyst estimate, 2026-06) — rather than a frontier-API share leader.", "Win enterprise buyers needing private/sovereign deployment, data residency, and knowledge-intensive (RAG) workloads where residency and control matter more than frontier benchmarks.", "Agentic layer is less visible than its model and retrieval strengths.", ["Models", "RAG", "Private deployment", "Sovereign deployment"], ["deployment controls", "data residency controls"], ["Tier-2 frontier position", "lower broad-market visibility"], "A credible specialist when private deployment, data residency, and RAG quality matter more than suite breadth; strongest on European/sovereign data-residency needs.", { roleTags: ["Model Provider", "Data & Services Provider", "Sovereign / Regional AI"] }),
  ...
  // ───────────── Specialist application leaders (added 2026-06-18 audit) ─────────────
  vendor("cursor", "Cursor (Anysphere)", "Developer/coding agent", 86, 74, "San Francisco, US", "private", ["Developer/coding agent", "AI IDE"], "The leading AI coding-agent IDE (~$29B valuation); the default surface for agentic coding, predominantly running Claude and other frontier models.", "Own the AI-native code-editor surface and agentic coding workflows; route to the best frontier models (Claude is the default) while building first-party agent orchestration.", "Strong agentic coding — multi-file edits and background agents; enterprise controls and audit are maturing.", ["AI IDE", "Coding agents", "Codebase RAG"], ["SSO", "privacy mode", "admin controls"], ["Model dependency on frontier providers", "enterprise-control depth maturing"], "Category leader for agentic coding — the #1 enterprise AI workload — and a major distribution channel for Claude; assess as an application layer with deep model dependency.", { roleTags: ["Application Vendor"] }),
  vendor("sierra", "Sierra", "CRM/customer AI", 78, 66, "San Francisco, US", "private", ["CRM/customer AI", "Customer-experience agents"], "Customer-experience AI-agent platform (Bret Taylor / Clay Bavor) for autonomous customer service, priced on resolved outcomes.", "Own outcome-based CX agents that resolve support interactions end-to-end, charging on resolution rather than seats.", "Strong customer-facing agent autonomy with guardrails; enterprise governance and audit are central buyer checkpoints.", ["CX agents", "Support automation", "Voice + chat"], ["agent guardrails", "audit logs", "escalation controls"], ["Outcome-pricing proof at scale", "crowded CX-agent category"], "A leading customer-experience agent specialist; assess in CX/support workflows, not as a horizontal platform.", { roleTags: ["Application Vendor", "Vertical Specialist"] }),
  vendor("abridge", "Abridge", "Regulated-industry AI", 77, 68, "Pittsburgh, US", "private", ["Regulated-industry AI", "Healthcare AI"], "Healthcare clinical-documentation leader; Epic-integrated ambient AI that drafts clinical notes from patient encounters.", "Own ambient clinical documentation through deep EHR (Epic) integration and clinician trust, then expand across the healthcare revenue-cycle workflow.", "Supervised clinical-note generation with clinician review; autonomy is bounded by safety and compliance.", ["Ambient documentation", "Epic integration", "Clinical NLP"], ["HIPAA", "audit logs", "clinician review"], ["Healthcare-vertical concentration", "clinical-safety + regulatory burden"], "The leading healthcare clinical-documentation specialist; assess inside health systems with HIPAA and clinical-safety evidence as the bar.", { roleTags: ["Vertical Specialist", "Application Vendor"] }),
...
const shareRows: [string, MarketCategoryId, number, number | undefined, number][] = [
  ...
  ["zai", "frontier_model_api", 2, 1, 45], ["minimax", "frontier_model_api", 1, 0, 44],
  ...
  ["salesforce", "crm_customer_ai", 34, 31, 72], ["microsoft", "crm_customer_ai", 14, 13, 56], ["oracle", "crm_customer_ai", 10, 10, 50], ["sierra", "crm_customer_ai", 7, 3, 58],
  ...
  ["harvey", "regulated_industry_ai", 13, 10, 57], ["abridge", "regulated_industry_ai", 9, 4, 60], ["ibm", "regulated_industry_ai", 12, 12, 65], ["cohere", "regulated_industry_ai", 8, 7, 50], ["rogo", "regulated_industry_ai", 5, 4, 42],
