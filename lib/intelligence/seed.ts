...
export const INTELLIGENCE_VENDORS: Vendor[] = [
  ...
  // NOTE: Aleph Alpha merged into Cohere (April 2026) and is no longer a
  // standalone vendor — see the "cohere" entry above. The watchlist that
  // referenced "aleph" now points to "cohere".
  ...
  // ───────────── Sovereign / regional specialists (Stage 1 fold-in) ─────────────
  ...
  // ───────────── Pure-play investors (Stage 1 fold-in) ─────────────
...
function vendor(
  ...
  extra?: { roleTags?: string[]; infraBand?: string },
): Vendor {
...
export const WATCHLISTS: Watchlist[] = [
  ...
  // non-US frontier set and open-weights momentum.
  {
    ...
    vendors: ["meta", "deepseek", "alibaba", "moonshot", "zai", "minimax", "mistral", "ai21", "cohere"],
