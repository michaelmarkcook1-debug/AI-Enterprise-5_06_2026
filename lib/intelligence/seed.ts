...
const shareRows: [string, MarketCategoryId, number, number | undefined, number][] = [
  ...
  ["openai", "frontier_model_api", 24, 26, 74], ["anthropic", "frontier_model_api", 15, 14, 67], ["google", "frontier_model_api", 14, 15, 62],
  ...
  // Enterprise assistant — Copilot reduced; lab-owners credited
  ["microsoft", "enterprise_assistant", 30, 31, 72], ["openai", "enterprise_assistant", 18, 13, 58], ["anthropic", "enterprise_assistant", 5, 4, 55], ["glean", "enterprise_assistant", 10, 8, 57], ["writer", "enterprise_assistant", 6, 5, 52],
  // Developer coding agent — same logic; Anthropic/Google credited for own coding models
  ["microsoft", "developer_coding_agent", 34, 36, 76], ["openai", "developer_coding_agent", 14, 10, 55], ["anthropic", "developer_coding_agent", 12, 8, 55], ["google", "developer_coding_agent", 8, 8, 49],
