...
export const SOURCE_MANIFEST: SourceManifestEntry[] = [
  ...
  { vendorId: "vendor_anthropic", category: "analyst_report",
    ...
    expectedDomains: ["model_quality", "agentic_autonomy"],
    freshnessHorizonDays: 14,
    notes: "Top-2 ELO average seeds overallScore. Refresh via Seed Arena ELO scores in Ingestion console." },
  { vendorId: "vendor_openai", category: "analyst_report",
    url: "https://openlm.ai/chatbot-arena/",
    label: "Arena ELO leaderboard — OpenAI",
    expectedDomains: ["model_quality", "agentic_autonomy"],
    freshnessHorizonDays: 14,
    notes: "Top-2 ELO average seeds overallScore." },
  { vendorId: "vendor_xai", category: "analyst_report",
    url: "https://openlm.ai/chatbot-arena/",
    label: "Arena ELO leaderboard — xAI",
    expectedDomains: ["model_quality", "agentic_autonomy"],
    freshnessHorizonDays: 14,
    notes: "Top-2 ELO average seeds overallScore." },
  { vendorId: "vendor_alibaba-qwen", category: "analyst_report",
    url: "https://openlm.ai/chatbot-arena/",
    label: "Arena ELO leaderboard — Alibaba Qwen",
    expectedDomains: ["model_quality", "agentic_autonomy"],
    freshnessHorizonDays: 14,
    notes: "Top-2 ELO average seeds overallScore." },
  { vendorId: "vendor_zhipu-glm", category: "analyst_report",
    url: "https://openlm.ai/chatbot-arena/",
    label: "Arena ELO leaderboard — Zhipu GLM",
    expectedDomains: ["model_quality", "agentic_autonomy"],
    freshnessHorizonDays: 14,
    notes: "Top-2 ELO average seeds overallScore." },
  { vendorId: "vendor_moonshot-kimi", category: "analyst_report",
    url: "https://openlm.ai/chatbot-arena/",
    label: "Arena ELO leaderboard — Moonshot Kimi",
    expectedDomains: ["model_quality", "agentic_autonomy"],
    freshnessHorizonDays: 14,
    notes: "Top-2 ELO average seeds overallScore." },
  { vendorId: "vendor_deepseek", category: "analyst_report",
    url: "https://openlm.ai/chatbot-arena/",
    label: "Arena ELO leaderboard — DeepSeek",
    expectedDomains: ["model_quality", "agentic_autonomy"],
    freshnessHorizonDays: 14,
    notes: "Top-2 ELO average seeds overallScore." },
  { vendorId: "vendor_mistral", category: "analyst_report",
    url: "https://openlm.ai/chatbot-arena/",
    label: "Arena ELO leaderboard — Mistral",
    expectedDomains: ["model_quality", "agentic_autonomy"],
    freshnessHorizonDays: 14,
    notes: "Top-2 ELO average seeds overallScore." },
  { vendorId: "vendor_meta", category: "analyst_report",
    url: "https://openlm.ai/chatbot-arena/",
    label: "Arena ELO leaderboard — Meta",
    expectedDomains: ["model_quality", "agentic_autonomy"],
    freshnessHorizonDays: 14,
    notes: "Top-2 ELO average seeds overallScore." },
  { vendorId: "vendor_cohere", category: "analyst_report",
    url: "https://openlm.ai/chatbot-arena/",
    label: "Arena ELO leaderboard — Cohere",
    expectedDomains: ["model_quality", "agentic_autonomy"],
    freshnessHorizonDays: 14,
    notes: "Top-2 ELO average seeds overallScore." },
];
